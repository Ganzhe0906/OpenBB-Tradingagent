...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            import os as _os
            if self.search_provider == "brave" and (self.search_api_key or _os.environ.get("BRAVE_API_KEY")):
                tools.register(BraveSearchTool(api_key=self.search_api_key))
            else:
                tools.register(TavilySearchTool(api_key=self.search_api_key))
