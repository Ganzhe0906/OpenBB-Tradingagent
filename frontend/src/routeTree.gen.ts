...
import { Route as AuthenticatedTvNewsRouteImport } from './routes/_authenticated/tv-news'
import { Route as AuthenticatedInvestmentDiaryRouteImport } from './routes/_authenticated/investment-diary'
import { Route as AuthenticatedClsNewsRouteImport } from './routes/_authenticated/cls-news'
...
const AuthenticatedTvNewsRoute = AuthenticatedTvNewsRouteImport.update({
  id: '/tv-news',
  path: '/tv-news',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
const AuthenticatedInvestmentDiaryRoute =
  AuthenticatedInvestmentDiaryRouteImport.update({
    id: '/investment-diary',
    path: '/investment-diary',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
const AuthenticatedClsNewsRoute = AuthenticatedClsNewsRouteImport.update({
  id: '/cls-news',
  path: '/cls-news',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/cls-news': typeof AuthenticatedClsNewsRoute
  '/investment-diary': typeof AuthenticatedInvestmentDiaryRoute
  '/tv-news': typeof AuthenticatedTvNewsRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/cls-news': typeof AuthenticatedClsNewsRoute
  '/_authenticated/investment-diary': typeof AuthenticatedInvestmentDiaryRoute
  '/_authenticated/tv-news': typeof AuthenticatedTvNewsRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/(errors)/500'
    | '/(errors)/503'
    | '/_authenticated/cls-news'
    | '/_authenticated/investment-diary'
    | '/_authenticated/tv-news'
    | '/_authenticated/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/tv-news': {
      id: '/_authenticated/tv-news'
      path: '/tv-news'
      fullPath: '/tv-news'
      preLoaderRoute: typeof AuthenticatedTvNewsRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/investment-diary': {
      id: '/_authenticated/investment-diary'
      path: '/investment-diary'
      fullPath: '/investment-diary'
      preLoaderRoute: typeof AuthenticatedInvestmentDiaryRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/cls-news': {
      id: '/_authenticated/cls-news'
      path: '/cls-news'
      fullPath: '/cls-news'
      preLoaderRoute: typeof AuthenticatedClsNewsRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/(errors)/503': {
      id: '/(errors)/503'
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedClsNewsRoute: typeof AuthenticatedClsNewsRoute
  AuthenticatedInvestmentDiaryRoute: typeof AuthenticatedInvestmentDiaryRoute
  AuthenticatedTvNewsRoute: typeof AuthenticatedTvNewsRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedClsNewsRoute: AuthenticatedClsNewsRoute,
  AuthenticatedInvestmentDiaryRoute: AuthenticatedInvestmentDiaryRoute,
  AuthenticatedTvNewsRoute: AuthenticatedTvNewsRoute,
